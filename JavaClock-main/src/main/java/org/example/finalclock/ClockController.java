...
public class ClockController {
    ...
    private void updateTime(ActionEvent e) {
        ...
        if (alarmTime != null) {
            alarmLabel.setText("The alarm clock will ring in: "+ alarmTime.getCurrentTime(false));
        } else {
            alarmLabel.setText("Alarm off");
        }
        if (alarmTime != null && !isAlarmToggled && (timeChangeable.getHours() == alarmTime.getHours())
            && (timeChangeable.getMinutes() == alarmTime.getMinutes()) && isAlarmOn) {
